...
await db.exec(`insert into leader_scopes(leader_id,course_id,created_by) values('${id(2)}','${id(12)}','${id(1)}');
insert into enrollments(id,profile_id,course_id,price_snapshot,payment_timing,status) values
('${id(30)}','${id(3)}','${id(12)}',100000,'deferred','pending_approval'),
('${id(33)}','${id(6)}','${id(22)}',100000,'deferred','pending_approval'),
('${id(34)}','${id(7)}','${id(12)}',100000,'deferred','pending_approval');`);
await asUser(id(2));
