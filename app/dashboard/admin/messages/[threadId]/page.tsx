...
import {
  closeLessonMessageThreadAction,
    ...
    <main className="mx-auto w-full max-w-5xl space-y-6 p-4 sm:p-6 lg:p-8">
          ...
          <form
            action={
              thread.status === "closed"
                ? reopenLessonMessageThreadAction.bind(null, thread.id)
      ...
      <section className="rounded-3xl border border-blue-100 bg-white p-5 shadow-sm sm:p-6">
        ...
        <p className="mt-1 text-sm leading-6 text-slate-500">
          Jawaban akan langsung tampil pada lesson peserta setelah halaman diperbarui.
        </p>
