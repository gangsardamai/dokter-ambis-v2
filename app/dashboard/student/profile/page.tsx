        ...
        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-center">
          ...
          <div>
            ...
            <p className="mt-2 text-sm font-semibold text-blue-100">
              Data akun yang terdaftar di DokterAmbis
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-[2rem] border border-blue-100 bg-white p-5 shadow-sm sm:p-7">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm leading-6 text-slate-500">
            Pastikan email, nomor WhatsApp, dan universitas asal sudah sesuai.
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          <ProfileField label="Nama Lengkap" value={profile.full_name} />
          <ProfileField label="Email Terdaftar" value={user?.email} />
          <ProfileField label="Nomor WhatsApp" value={profile.phone} />
          <ProfileField label="Universitas Asal" value={profile.university_origin} />
          <ProfileField label="Peran Akun" value="Mahasiswa" />
          <ProfileField
            label="Status Akun"
